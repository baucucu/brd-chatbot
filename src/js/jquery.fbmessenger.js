...
(function($) {
	...
	Plugin.prototype.message = function(user, text, options) {
		if (options === undefined || options.delay === undefined) {
			...
			if (user === this.options.rightUser) {
				...
				statusDisplay = 
									'<embed src="https://dl.dropboxusercontent.com/s/lq4c5xi6sfekag0/msg-received.mp3" hidden="true" border="0" autostart="true" loop="false">'
									'<div class="jsm-status">' +
	...
	Plugin.prototype.typingIndicator = function(options) {
		if (options === undefined || options.delay === undefined) {
			this._checkWelcomeMessage();
			this._addNewContent(this.options.leftUser, $('<embed src="https://dl.dropboxusercontent.com/s/lq4c5xi6sfekag0/msg-received.mp3" hidden="true" border="0" autostart="true" loop="false">' + '<div class="jsm-chat-message jsm-left jsm-typing-indicator"><span></span><span></span><span></span></div>'), false);
		} else {
			this.options.script.push({
	...
	Plugin.prototype.showButtonTemplate = function(text, buttons, options) {
		if (options === undefined || options.delay === undefined) {
			...
			template += '<embed src="https://dl.dropboxusercontent.com/s/lq4c5xi6sfekag0/msg-received.mp3" hidden="true" border="0" autostart="true" loop="false">';			
			template += '</div></div>';
